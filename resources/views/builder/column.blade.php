<div
    class="relative group relative bg-builder-section border border-builder-border rounded-lg mb-8 transition-all duration-300 {{ $width }}">
    <div
    ...
    <div class="
                ...
                ">
        @include('builder.header-title', ['text' => 'Column'])
    ...
    <div class="px-2 space-y-4">
        ...
        <?php
            $possible = [
                ...
                'builder.components.gallery'
            ];

        for ($i = 0; $i < 5; $i++) {
            $possible[] = \Arr::random($possible);
        }
        shuffle($possible);
        $possible = array_slice($possible, 0, rand(1,2));
            ?>
