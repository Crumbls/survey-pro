            ...
            <div class="container px-4 mx-auto">
                ...
                <span class="inline-block px-4 py-1.5 mb-6 text-sm font-semibold bg-teal-50 text-teal-600 rounded-full">
                    ...
                    <div class="flex flex-wrap justify-center gap-4">
                        <a href="#" class="inline-flex items-center justify-center gap-2 px-8 py-3 text-sm font-medium text-white bg-teal-600 rounded-md hover:bg-teal-700 transition-all duration-200 shadow-lg hover:shadow-xl">
