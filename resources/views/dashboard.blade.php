...
<x-layout>
    <div class="container mx-auto px-4 py-8">
        ...
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-slate-900">Production Dashboard</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-lg p-6 border border-slate-200">
                ...
                <div class="space-y-2">
                    ...
                    <?php
                    $count = \App\Models\User::whereIn('id',
                            \App\Models\TenantUserRole::select('user_id')
                                ->whereIn('tenant_id', auth()->user()->tenants()->select('tenant_id'))
                        )->count();
                    ?>
